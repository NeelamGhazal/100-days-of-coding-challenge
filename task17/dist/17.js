...
guestList.forEach(function (oneguest) { return console.log("Dear " + oneguest + ", You are invited to the dinner."); });
...
guestList.forEach(function (twoGuest) { return console.log("Fortunately, " + twoGuest + " you are still warmly invited to join us for dinner."); });
