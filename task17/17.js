...
while (guestList.length > 2) {
    ...
    console.log("Apologies, ".concat(removedGuest, " I'm unable to extend an invitation to you for dinner."));
}
//Sending a invitations to the last two guest on the list
console.log("\nInvitations for the remaining two guests.");
guestList.forEach(function (twoGuest) { return console.log("Fortunately, ".concat(twoGuest, " you are still warmly invited to join us for dinner.")); });
